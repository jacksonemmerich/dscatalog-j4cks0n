...
import com.j2emme.dscatalog.services.ProductService;
...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		when(service.findaById(existingId)).thenReturn(productDTO);
		when(service.findaById(nonExistingId)).thenThrow(ResourceNotFoundException.class);
